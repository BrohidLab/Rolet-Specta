    ...
    <section id="about" class="py-28 px-6 lg:px-12 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            <div>
                ...
                <img src="https://images.unsplash.com/photo-1521017432531-fbd92d768814?q=80&w=1974&auto=format&fit=crop"
                    class="rounded-[40px] h-[600px] w-full object-cover shadow-2xl shadow-black/40" alt="Nature Cafe">
            ...
            <div>
                ...
                <p class="mt-8 text-gray-300 text-lg leading-relaxed">
                    ...
                    Kami menghadirkan cafe premium dengan pemandangan alam luas,
                ...
                <div class="mt-10 grid sm:grid-cols-2 gap-6">
                    ...
                    <div class="glass rounded-3xl p-6">
                        ...
                        <p class="mt-3 text-gray-300 text-sm leading-relaxed">
                            ...
                            Nikmati udara pegunungan yang sejuk dan nyaman.
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="gallery-hover overflow-hidden rounded-[35px] relative h-[450px]">
                    ...
                    <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=1974&auto=format&fit=crop"
                ...
                <div class="gallery-hover overflow-hidden rounded-[35px] relative h-[450px]">
                    ...
                    <img src="https://images.unsplash.com/photo-1511920170033-f8396924c348?q=80&w=1974&auto=format&fit=crop"
                        class="w-full h-full object-cover" alt="Gallery">
                ...
                <div class="gallery-hover overflow-hidden rounded-[35px] relative h-[450px]">
                    ...
                    <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=1974&auto=format&fit=crop"
                        class="w-full h-full object-cover" alt="Gallery">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass rounded-[35px] overflow-hidden hover:-translate-y-2 transition duration-500">
                    ...
                    <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=1974&auto=format&fit=crop"
                        class="h-[260px] w-full object-cover" alt="Coffee">
                    ...
                    <div class="p-7">
                        ...
                        <p class="mt-4 text-gray-300 leading-relaxed">
                            Kopi premium dengan rasa creamy dan aroma khas.
                        </p>
                ...
                <div class="glass rounded-[35px] overflow-hidden hover:-translate-y-2 transition duration-500">
                    ...
                    <div class="p-7">
                        ...
                        <p class="mt-4 text-gray-300 leading-relaxed">
                            Sensasi kopi modern dengan foam lembut premium.
                        </p>
                ...
                <div class="glass rounded-[35px] overflow-hidden hover:-translate-y-2 transition duration-500">
                    ...
                    <div class="p-7">
                        ...
                        <p class="mt-4 text-gray-300 leading-relaxed">
                            Espresso autentik dengan rasa strong terbaik.
                        </p>
            ...
            <div class="min-h-[650px] flex items-center">
                ...
                <div class="max-w-3xl">
                    ...
                    <p class="mt-8 text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl">
                        ...
                        udara sejuk, dan suasana premium khas Rolet Specta
